              ...
              {activeGoals.length === 0 ? (
                ...
                activeGoals.slice(0, 3).map((g: any) => {
                  ...
                  return (
                    <div
                      key={g.id}
                      className="bg-secondary/15 border border-border/30 rounded-2xl p-3.5 space-y-3"
                    >
                      <div className="flex items-center justify-between gap-3">
                        <div className="min-w-0 flex-1">
                          <h3 className="text-xs font-bold truncate">{g.title}</h3>
                        ...
                        <div className="relative h-11 w-11 shrink-0">
                          ...
                          <div className="absolute inset-0 flex flex-col items-center justify-center">
                            ...
                            <span className="text-[6px] text-muted-foreground uppercase leading-none font-bold scale-90">
                              Health
                            </span>
                          </div>
                        </div>
            ...
            <div className="space-y-2.5">
              {opportunitySignals.length === 0 ? (
                <div className="flex items-center gap-2.5 rounded-2xl bg-emerald-500/5 border border-emerald-500/10 p-3.5">
                  ...
                  <div className="text-[10px] text-emerald-600 dark:text-emerald-400">
                    ...
                    <span className="mt-0.5 block leading-normal">
                      FlowPilot found zero warnings! Momentum is robust.
                    </span>
                  </div>
                </div>
              ) : (
                opportunitySignals.slice(0, 3).map((sig: any) => {
                  let badgeStyle =
                    "bg-violet-500/5 border-violet-500/10 text-violet-600 dark:text-violet-400";
                  ...
                  return (
                    <div
                      key={sig.id}
                      className={cn("rounded-2xl border p-3 space-y-2 select-none", badgeStyle)}
                    >
                      ...
                      <div>
                        <h3 className="text-xs font-bold leading-tight text-foreground/80">
                          {sig.title}
                        </h3>
