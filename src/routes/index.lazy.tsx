  ...
  return (
    <section className="relative overflow-hidden pt-12 md:pt-20">
      ...
      <div className="mx-auto max-w-6xl px-4 text-center">
        ...
        >
          Plan your day, balance focus and rest, and let an adaptive AI co-pilot orchestrate tasks,
          habits, and deadlines — beautifully.
        </motion.p>
        ...
        >
          <Link
            to="/app/dashboard"
            className="group inline-flex items-center gap-2 rounded-full bg-foreground px-6 py-3 text-sm font-medium text-background shadow-float transition-all hover:scale-[1.02]"
          >
            Open FlowPilot{" "}
          ...
          <a
            href="#features"
            className="inline-flex items-center gap-2 rounded-full border border-border bg-white/70 px-6 py-3 text-sm font-medium backdrop-blur hover:bg-white"
          >
...
const features = [
  {
    icon: Brain,
    color: "lavender",
    title: "Adaptive AI Planner",
    desc: "An AI that learns your rhythm and rewrites your day when life shifts.",
  },
  {
    icon: Target,
    color: "mint",
    title: "Smart Task Triage",
    desc: "Auto-prioritized tasks with deadline awareness and effort estimation.",
  },
  {
    icon: BarChart3,
    color: "sky",
    title: "Productivity Analytics",
    desc: "Beautiful charts that turn your effort into insights you can act on.",
  },
  {
    icon: Zap,
    color: "peach",
    title: "Focus Sessions",
    desc: "Distraction-free sprints with dynamic breaks and ambient cues.",
  },
  {
    icon: Calendar,
    color: "lavender",
    title: "Unified Calendar",
    desc: "Tasks, meetings, and habits — orchestrated in one elegant timeline.",
  },
  {
    icon: Bot,
    color: "sky",
    title: "Conversational Assistant",
    desc: 'Ask anything: "Plan my week", "Reschedule unfinished work".',
  },
];
...
const steps = [
  {
    ...
    desc: "Bring your tasks, calendars, and habits into a single, calm canvas.",
  },
  {
    n: "02",
    title: "Let AI plan",
    desc: "Your assistant designs the perfect day, balancing focus, energy, and rest.",
  },
  {
    n: "03",
    title: "Stay in flow",
    desc: "Gentle nudges, smart reschedules, and analytics that learn what works for you.",
  },
];
...
const testimonials = [
  {
    name: "Alex Chen",
    role: "Software Engineer & Indie Maker",
    quote:
      "FlowPilot is the first productivity tool that actually feels like a teammate. The AI planner is uncanny.",
    color: "lavender",
  },
  {
    name: "Sarah Ortiz",
    role: "Tech Lead & Blogger",
    quote:
      "It quietly orchestrates my week. I open my laptop and my day is already drafted, beautifully.",
    color: "mint",
  },
  {
    name: "Michael Khan",
    ...
    quote:
      "I dropped three apps the week I started using FlowPilot. The focus sessions alone are worth it.",
    color: "sky",
  },
];
          ...
          >
            ...
            <div className="mt-6 flex items-center gap-3">
              <div
                ...
                style={{ background: `color-mix(in oklab, var(--${t.color}) 70%, white)` }}
              />
              <div>
...
const faqs = [
  {
    q: "Is FlowPilot really powered by AI?",
    a: "Yes. Our adaptive planner uses an LLM-backed engine to score, schedule, and reflow your day based on context.",
  },
  {
    q: "Can I use it for free?",
    a: "FlowPilot has a generous free tier including core planning, tasks, and analytics.",
  },
  {
    q: "Does it work on mobile?",
    a: "Absolutely. The app is fully responsive and built for touch-first interactions.",
  },
  {
    q: "What integrations are supported?",
    a: "Currently, FlowPilot is a standalone system with private local storage. Integrations with Google Calendar, Notion, and GitHub are on our active immediate roadmap.",
  },
];
        ...
        {faqs.map((f) => (
          <details key={f.q} className="group p-6">
            <summary className="flex cursor-pointer items-center justify-between text-sm font-medium">
              {f.q}
              <span className="ml-4 grid h-6 w-6 place-items-center rounded-full bg-secondary text-foreground transition-transform group-open:rotate-45">
                +
              </span>
            </summary>
    ...
    <section className="mx-auto max-w-7xl px-4 pb-24">
      <div className="relative overflow-hidden rounded-3xl border border-border/60 bg-card p-10 text-center shadow-float md:p-16">
        ...
        <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
          <Link
            to="/signup"
            className="rounded-full bg-foreground px-6 py-3 text-sm font-medium text-background shadow-float hover:opacity-90"
          >
            Get started free
          </Link>
          <Link
            to="/app/dashboard"
            className="rounded-full border border-border bg-white/70 px-6 py-3 text-sm font-medium backdrop-blur hover:bg-white"
          >
            Explore the demo
          </Link>
        </div>
      ...
      <div className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-6 px-4 py-10 md:flex-row md:items-center">
        ...
        <div className="grid grid-cols-3 gap-10 text-xs text-muted-foreground">
          <div className="space-y-2">
            ...
            <a href="#how" className="block hover:text-foreground">
              How it works
            </a>
          </div>
          <div className="space-y-2">
            <div className="font-medium text-foreground">Company</div>
            <a href="#about" className="block hover:text-foreground">
              About
            </a>
            <a href="#careers" className="block hover:text-foreground">
              Careers
            </a>
          </div>
          <div className="space-y-2">
