...
export interface AIAssistantResponse {
  ...
  action?: {
    type: 'reschedule_plan' | 'create_task' | 'toggle_habit' | 'none' | 'create_goal' | 'complete_goal' | 'delete_goal' | 'show_goals' | 'enable_demo' | 'show_schedule' | 'show_analytics' | 'move_block' | 'regenerate_plan';
